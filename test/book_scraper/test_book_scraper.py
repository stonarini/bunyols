...
links = [
    ...
    (
        "https://www.amazon.com/Divina-Commedia-Inferno-Purgatorio-Paradiso/dp/B08P3SLT1S/",
        (
            None,
            ["Classic"],
        ),
    ...
    (
        "https://www.amazon.com/Industrial-Society-Its-Future-Unabomber/dp/B086Y5JY5K/ref=sr_1_1?crid=GIAFIE2ZH6DV&keywords=ted+kaczynski&qid=1638491486&sprefix=ted+ka%2Caps%2C264&sr=8-1",
        (
            None,
            ["Manifesto"],
        ),
